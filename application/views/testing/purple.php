...
<body>
	...
	<div class="container">
		...
		<article>
			...
			<img src="//www.cems.uwe.ac.uk/~b2-argo/images/purple_route.svg" alt="Purple Route" style="width: 100%;" class="purple-route">

			<hr class="row clearfix">

			<?php echo form_open('testing/feedback'); ?>

				<?php echo form_hidden('route', 'purple'); ?>
